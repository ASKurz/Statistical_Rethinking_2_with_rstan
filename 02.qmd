...
The **rstan** package uses a version of MCMC to fit Bayesian models. Since one of the main goals of this project is to highlight **rstan**, we may as well fit a model right here. This seems like an appropriately named subsection to do so. If you haven't already installed **rstan**, you can find instructions [here](https://github.com/stan-dev/rstan/wiki/RStan-Getting-Started).
