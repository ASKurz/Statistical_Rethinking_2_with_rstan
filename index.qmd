...
packages <- c("dagitty", "devtools", "GGally", "ggdag", "patchwork", "posterior", "remotes", "rstan", "tidybayes", "tidyverse", "tigris")
...
* Andrew Johnson  ([\@andrjohns](https://github.com/andrjohns)), and
