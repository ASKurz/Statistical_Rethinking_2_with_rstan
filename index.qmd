...
Each of these folks have shared **rstan** code that a directly helped make this book possible. I especially appreciate and recommend Arel-Bundock's website [*Statistical Rethinking 2 with Stan and R*](https://vincentarelbundock.github.io/rethinking2/), wherein you can find rendered `Rmarkdown` files with loads of **rstan** code on many of the same problems I'm tackling in this book. If you compare our works, you'll see I have been heavily influenced by Arel-Bundock's **rstan** style.
