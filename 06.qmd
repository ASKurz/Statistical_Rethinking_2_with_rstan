...
The results mimic those in the text. The posterior standard deviations are very large for $\beta_1$ and $\beta_2$. Here's a coefficient plot.
...
Define the two univariable models, and the multivariable model.
